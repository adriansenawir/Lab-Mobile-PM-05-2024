...
public class PostinganAdapter extends RecyclerView.Adapter<PostinganAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PostinganAdapter.ViewHolder holder, int position) {
        ...
        // Menambahkan OnClickListener untuk foto profil
        holder.ivProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Mengirim intent ke halaman profil dengan objek Instagram sebagai ekstra
        ...
        // Menambahkan OnClickListener untuk nama pengguna
